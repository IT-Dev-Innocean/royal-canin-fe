...
export function ParticipantAddModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (form.rc_club) payload.rc_club = true;
    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
      ...
      <div className='relative z-10 flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-2xl bg-white shadow-2xl'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-1 flex-col overflow-hidden'>
          <div className='flex-1 space-y-4 overflow-y-auto px-5 py-4'>
            ...
            <div>
              ...
              <input
                ...
                className={
                  fieldError('outlet_number') ? inputError : inputNormal
                }
              />
          ...
          <div className='flex flex-col gap-3 border-t border-gray-100 p-5 md:flex-row'>
            <button
              type='button'
              disabled={saving}
              onClick={resetAndClose}
