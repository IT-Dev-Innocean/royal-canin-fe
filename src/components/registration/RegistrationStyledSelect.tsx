...
const triggerClass =
  "inline-flex h-[42px] w-full shrink-0 items-center justify-between gap-2 rounded-[10px] border border-neutral-300 bg-white px-3.5 py-2 text-left text-sm text-neutral-900 shadow-none outline-none transition hover:border-neutral-400 focus:border-[#e2001a] focus:ring-1 focus:ring-[#e2001a] data-[placeholder]:text-neutral-400 [&>span]:min-w-0 [&>span]:truncate";
