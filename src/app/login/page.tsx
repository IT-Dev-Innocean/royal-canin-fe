...
const fieldInputClass =
  'w-full text-sm md:text-base rounded-sm border border-neutral-300 bg-white px-3 py-2.5 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-[#e2001a] focus:outline-none focus:ring-1 focus:ring-[#e2001a]';
      ...
      <div className='relative mx-auto flex justify-center h-[90vh] max-w-lg flex-col gap-6 px-4 pb-8 pt-8'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          <div className='rounded-md border border-neutral-200/90 bg-white p-5 shadow-sm sm:p-6'>
            ...
            <p className='mt-3 text-sm md:text-base italic text-neutral-500'>
