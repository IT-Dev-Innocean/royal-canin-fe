...
export default function PembicaraPage() {
  ...
  return (
    <main className='flex flex-col items-center p-6 min-h-screen text-black relative pb-28'>
      {/* Header */}
        ...
        {speakersData.map((speaker) => (
          <div
            ...
            <div className='flex items-center gap-4 pl-2'>
              <div className='w-14 h-14 rounded-full overflow-hidden bg-red-50 border-2 border-white shadow-sm shrink-0 relative'>
                <Image
                  src={speaker.image}
                  alt={speaker.name}
                  fill
              ...
              <div className='flex-1'>
                <h2 className='text-[12px] font-bold text-rc-red leading-tight mb-1 line-clamp-1'>
                  {speaker.name}
                </h2>
          ...
          <div className='relative bg-white rounded-[32px] w-full max-w-[320px] shadow-2xl scale-in-center overflow-hidden flex flex-col max-h-[85vh]'>
            ...
            <div className='p-6 overflow-y-auto'>
              ...
              <div className='text-center mb-6'>
                <h3 className='text-[15px] font-bold text-rc-red mb-2'>
              ...
              <div className='bg-red-50/50 rounded-2xl p-4 border border-red-100 mb-6'>
                <p className='text-[10px] font-bold text-rc-red uppercase tracking-wider mb-2 flex items-center gap-1.5'>
                  <svg
                    className='w-3 h-3'
                    fill='currentColor'
                    viewBox='0 0 20 20'>
